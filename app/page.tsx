    ...
    <div className="flex relative">
      <div className="w-[65%] flex-col items-center">
        ...
        <div className="flex items-center mt-[4%]">
          <Btn className=" w-[25%] shadow-[0_0_10px_2px_#42b847] ml-[15%] py-[4vh] font-bold" text="Projects" siteLink="/projects" icon={<AiOutlineFundProjectionScreen className="text-[20px] text-white mr-[-10px]"/>}/>
