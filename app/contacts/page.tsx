...
export default function Home(){
    ...
    <main className="w-full h-screen flex flex-col overflow-y-auto overflow-x-hidden">
      <div className="lg:w-[65%] w-full flex-col items-center z-1">
        <Header />
          ...
          <div className="w-full h-auto flex flex-col mt-5 lg:flex-row">
            ...
            <div className="w-75 lg:w-[35%] h-auto shadow-[0_0_20px_1px_rgba(0,0,0,0.2)] border-l-5 border-l-[#42b847] flex flex-col items-center justify-center bg-linear-to-br bg-white mt-[3vh] rounded-[20px]">
              <div className="relative w-full flex items-center justify-center">
                <Image src="/img/pixgenie_1762528408931.png" alt="Descrizione immagine" width={1000} height={1000} className="w-[50%] lg:w-[43%] h-auto object-cover [mask-image:linear-gradient(to_top,transparent_0%,black_40%)]"/>
              </div>
              ...
              <a href="https://cal.eu/constantin-glavan-yfle0e/introduction-meeting" className="lg:justify-start lg:w-auto lg:mt-0 bg-[#42b847] py-[2vh] mb-5 w-[90%] px-5 rounded-[20px] font-bold text-white text-[16px] flex items-center justify-center"><FaRegCalendarAlt className="mr-1"/>Book a meeting</a>
            </div>
